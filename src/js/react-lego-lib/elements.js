...
export const Brick = styled.div`
    ...
    .stud:before {
        background: ${props => lighten(0.16, props.color)}
    }
    .stud--inner:after {
        color: ${props => props.color};
        text-shadow: ${props => `0.4px 0.4px 0px ${lighten(0.04, props.color)}`};
    }
    ...
    ${props => props.size === 'small' && css`
      ...
      .stud {
        ...
        box-shadow: inset -2px 3px 3px ${darken(0.08, props.color)};
        height: 15px;
        left: 14px;
        top: 2px;
        width: 18px;
    ...
    ${props => props.size === 'medium' && css`
      ...
      .stud {
        ...
        box-shadow: inset -4px 6px 6px ${darken(0.08, props.color)};
        height: 26.5px;
        left: 24px;
        top: 3px;
        width: 32px;
...
export const Stud = styled.div`
    ...
    &:before {
      content: "";
      position: absolute;
      box-shadow: ${props => `inset 0px 0px 0.5px 0.5px ${darken(0.02, props.color)}`};
      height: 20px;
      width: 36px;
      border-radius: 18px / 10px;
      z-index: 10;
